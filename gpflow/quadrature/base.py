...
check_quadrature_fun_shapes = check_shapes(
    "X: [N_quad_points, batch..., D]",
    "return: [N_quad_points, batch..., broadcast D]",
)
...
class GaussianQuadrature:
    ...
    def __call__(
        ...
        **kwargs: Any,
        ...
        :param fun: Callable or Iterable of Callables that operates elementwise, with
            ...
            Use the :func:``check_quadrature_fun_shapes`` decorator to check the shapes of fun.
    ...
    def logspace(
        ...
        **kwargs: Any,
        ...
        :return: Gaussian log-expectation of a the exponential of a function f
        """
